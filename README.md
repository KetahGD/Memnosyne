...
La version actual es `v1.2.6`. El indicador visible se genera desde `version.js` y el registro formal vive en `VERSION.json` y `CHANGELOG.md`.
...
La version `v1.2.6` mantiene los datos del informe y presenta el Inicio con imagenes ceremoniales locales, sin rotulos visibles de wireframe ni superposiciones en los controles flotantes:
