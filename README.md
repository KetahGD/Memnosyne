...
La version actual es `v1.2.8`. El indicador visible se genera desde `version.js` y el registro formal vive en `VERSION.json` y `CHANGELOG.md`.
...
La version `v1.2.8` mantiene los datos del informe y presenta Inicio y Fundacion con las imagenes ceremoniales locales, sin rotulos visibles de wireframe ni superposiciones en los controles flotantes:
